...
//Bu kod, API’ye gelen isteklerde X-Api-Key kontrolü yapar, geçerli ve onaylı firmalara izin verir, diğerlerini daha controller’a gelmeden engeller.
...
/*
IUnitOfWork → veritabanına erişmek için

IAsyncActionFilter → Action çalışmadan önce araya girmek için

Mvc → HTTP response dönebilmek için*/
